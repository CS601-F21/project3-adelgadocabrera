...
import com.cs601.project3.AmazonReviews.models.JsonParserResponse;
import com.cs601.project3.AmazonReviews.models.Review;
...
public class ReviewsFinder extends DocsFinder<Review> {
     ...
     * @throws Exception
     */
    public static ReviewsFinder build(String fileName) throws Exception {
        JsonParser<Review> parser = new JsonParser<>(Review.class);
        JsonParserResponse<Review> parserResponse = parser.parse(fileName);
